...
//     version 1.2.0
//     from Assets/VR_Setup/Default Input Actions/XRI Default Input Actions.inputactions
//
...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
    ...
    ""controlSchemes"": [
        ...
        m_Custom_SpawnBuilding = m_Custom.FindAction("SpawnBuilding", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Custom_SpawnBuilding;
    public struct CustomActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        public CustomActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @SpawnBuilding => m_Wrapper.m_Custom_SpawnBuilding;
        ...
        public void SetCallbacks(ICustomActions instance)
        {
            ...
            {
                @SpawnBuilding.started -= m_Wrapper.m_CustomActionsCallbackInterface.OnSpawnBuilding;
                @SpawnBuilding.performed -= m_Wrapper.m_CustomActionsCallbackInterface.OnSpawnBuilding;
                @SpawnBuilding.canceled -= m_Wrapper.m_CustomActionsCallbackInterface.OnSpawnBuilding;
            }
