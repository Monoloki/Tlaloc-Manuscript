...
//     version 1.2.0
//     from Assets/Default Input Actions/XRI Default Input Actions.inputactions
//
...
public partial class @XRIDefaultInputActions : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""Custom"",
            ""id"": ""aa24f724-02d3-4971-ae70-f6cbc0ccdebb"",
            ""actions"": [
                {
                    ""name"": ""Active Building"",
                    ""type"": ""Button"",
                    ""id"": ""7f3a6e4c-4738-402d-8e42-d3c13645f639"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                ...
                {
                    ""name"": ""Active Building Menu"",
                    ""type"": ""Button"",
                    ""id"": ""82fede66-77f9-489b-a736-125ee300271c"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                {
                    ...
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""Active Building"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                },
                {
                    ""name"": """",
                    ""id"": ""b05c61d6-3d3b-459e-9d57-78a7a60cfcbc"",
                    ""path"": ""<XRController>{LeftHand}/primaryButton"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""Active Building Menu"",
                    ""isComposite"": false,
                    ""isPartOfComposite"": false
                }
            ]
    ...
    ""controlSchemes"": [
        ...
        m_Custom_ActiveBuilding = m_Custom.FindAction("Active Building", throwIfNotFound: true);
        m_Custom_ActiveBuildingMenu = m_Custom.FindAction("Active Building Menu", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_Custom_ActiveBuilding;
    private readonly InputAction m_Custom_ActiveBuildingMenu;
    public struct CustomActions
    {
        private @XRIDefaultInputActions m_Wrapper;
        public CustomActions(@XRIDefaultInputActions wrapper) { m_Wrapper = wrapper; }
        public InputAction @ActiveBuilding => m_Wrapper.m_Custom_ActiveBuilding;
        public InputAction @ActiveBuildingMenu => m_Wrapper.m_Custom_ActiveBuildingMenu;
        ...
        public void SetCallbacks(ICustomActions instance)
        {
            ...
            {
                @ActiveBuilding.started -= m_Wrapper.m_CustomActionsCallbackInterface.OnActiveBuilding;
                @ActiveBuilding.performed -= m_Wrapper.m_CustomActionsCallbackInterface.OnActiveBuilding;
                @ActiveBuilding.canceled -= m_Wrapper.m_CustomActionsCallbackInterface.OnActiveBuilding;
                @ActiveBuildingMenu.started -= m_Wrapper.m_CustomActionsCallbackInterface.OnActiveBuildingMenu;
                @ActiveBuildingMenu.performed -= m_Wrapper.m_CustomActionsCallbackInterface.OnActiveBuildingMenu;
                @ActiveBuildingMenu.canceled -= m_Wrapper.m_CustomActionsCallbackInterface.OnActiveBuildingMenu;
            }
            m_Wrapper.m_CustomActionsCallbackInterface = instance;
            if (instance != null)
            {
                @ActiveBuilding.started += instance.OnActiveBuilding;
                @ActiveBuilding.performed += instance.OnActiveBuilding;
                @ActiveBuilding.canceled += instance.OnActiveBuilding;
                @ActiveBuildingMenu.started += instance.OnActiveBuildingMenu;
                @ActiveBuildingMenu.performed += instance.OnActiveBuildingMenu;
                @ActiveBuildingMenu.canceled += instance.OnActiveBuildingMenu;
            }
        }
    }
    ...
    {
        void OnActiveBuilding(InputAction.CallbackContext context);
        void OnActiveBuildingMenu(InputAction.CallbackContext context);
    }
}
